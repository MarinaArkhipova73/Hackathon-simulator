...
INSERT INTO public.answer (id, inspiration_points, knowledge_points, time_points, value) VALUES (10, -6, -2, -2, 'Отчаюсь, впаду в депрессию и отрежу связь с внешним миром и командой');
INSERT INTO public.answer (id, inspiration_points, knowledge_points, time_points, value) VALUES (11, 0, -1, -4, 'Попробую договориться с администрацией и зарегистрирую знакомого программиста, который согласился помочь');
INSERT INTO public.answer (id, inspiration_points, knowledge_points, time_points, value) VALUES (12, -2, -2, -1, 'Проведу мотивационную речь, чтобы поднять моральный дух команды и уверить их, что без Васи всё прекрасно обойдётся');
INSERT INTO public.answer (id, inspiration_points, knowledge_points, time_points, value) VALUES (13, 3, 1, -2, 'Устроить тренинг по командообразованию');
INSERT INTO public.answer (id, inspiration_points, knowledge_points, time_points, value) VALUES (14, -1, -2, 1, 'Сходить вместе в бар');
INSERT INTO public.answer (id, inspiration_points, knowledge_points, time_points, value) VALUES (15, 5, 3, -4, 'Посетить конференцию по разработке');
