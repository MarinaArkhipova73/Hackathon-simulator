...
<div>
    <svg class="intro-bg-shape" viewBox="0 0 827 827" version="1.1" xmlns="http://www.w3.org/2000/svg"
         xmlns:xlink="http://www.w3.org/1999/xlink">
        <title>Rectangle 3</title>
        <desc></desc>
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Artboard" transform="translate(-294.000000, -236.000000)" fill="#d5ebff">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 intro-text">
                ...
                <a role="button" href="/" class="btn btn-primary btn-block">НАЧАТЬ ТЕСТ</a>
            </div>

            <div class="col-sm-6">
                <br>
                <img src="../static/image/homeback-r.png" alt="" class="img-fluid">
            </div>
        </div>
    </div>
</section>
